...
x1 = xlsread('平均提交速度.xlsx', 'Sheet1', 'B2:B13'); 
% 创建纵坐标向量,读取Excel文件中C列第2行到第13行的数据
y1 = xlsread('平均提交速度.xlsx', 'Sheet1', 'C2:C13'); 

% meteor仓库
% 创建横坐标向量,读取Excel文件中B列第17行到第28行的数据
x2 = xlsread('平均提交速度.xlsx', 'Sheet1', 'B17:B28'); 
% 创建纵坐标向量,读取Excel文件中C列第17行到第28行的数据
y2 = xlsread('平均提交速度.xlsx', 'Sheet1', 'C17:C28'); 
...
x4 = xlsread('平均提交速度.xlsx', 'Sheet1', 'B47:B58'); 
% 创建纵坐标向量,读取Excel文件中C列第47行到第58行的数据
y4 = xlsread('平均提交速度.xlsx', 'Sheet1', 'C47:C58'); 

% left仓库
% 创建横坐标向量,读取Excel文件中B列第62行到第73行的数据
x5 = xlsread('平均提交速度.xlsx', 'Sheet1', 'B62:B73'); 
% 创建纵坐标向量,读取Excel文件中C列第62行到第73行的数据
y5 = xlsread('平均提交速度.xlsx', 'Sheet1', 'C62:C73'); 
